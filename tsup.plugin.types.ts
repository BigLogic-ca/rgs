...
const Types = {
  ...
  buildEnd() {
    ...
    // // Patch dist/types/index.d.ts to reference [pk.code].d.ts
    ...
    //   const ref = `/// <reference path="./${pk.code}.d.ts" />\n`
    //   if (!content.startsWith(ref)) {
    //     fs.writeFileSync(distIndexDts, ref + content, 'utf8')
    //     console.debug(`-----> Patched dist/types/index.d.ts with ${pk.code}.d.ts reference.`)
    //   }
    // }
